...
docs:
  - name: README.md
    ...
    ispdf: no
    ishtml: no
  - name: Data_Sources.docx
    file: Data_Sources.docx
    readme: no
    ispdf: no
    ismd: no
    ispage: no
